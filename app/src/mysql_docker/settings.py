...
class Config(object):
    ...
    # branding
    THISAPP_PRODUCTNAME = '<span class="brand-all"><span class="brand-left">mysql</span><span class="brand-right">-docker</span></span>'
    THISAPP_PRODUCTNAME_TEXT = 'mysql-docker'
